...
resource "aws_acm_certificate" "lb_tls_cert" {
  private_key      = data.aws_secretsmanager_secret_version.lb_tls_key.secret_string
  certificate_body = data.aws_secretsmanager_secret_version.lb_tls_cert.secret_string
}
